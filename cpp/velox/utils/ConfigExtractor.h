...
inline constexpr std::string_view kInvalidGcsCredentialsProviderName = "gluten-invalid-runtime-gcs-configuration";
inline constexpr std::string_view kInvalidGcsEndpoint = "https://gluten-invalid-runtime-gcs-configuration.invalid";
